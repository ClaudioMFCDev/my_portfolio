...
export default function Footer() {
  return (
    <section id="footer" className="container mx-auto flex justify-center items-center w-full">
      <div className="flex flex-col sm:flex-row mt-0.5 sm:mt-1 sm:h-16 w-full justify-center">
        ...
        <div className="flex justify-center sm:flex-row mt-1 hover:animate-bounce">
